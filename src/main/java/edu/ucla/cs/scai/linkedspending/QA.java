...
import edu.ucla.cs.scai.linkedspending.qald.JsonDataset;
import edu.ucla.cs.scai.linkedspending.qald.JsonQuery;
import edu.ucla.cs.scai.linkedspending.qald.JsonQuestion;
import edu.ucla.cs.scai.linkedspending.qald.SparqlEndpoint;
import edu.ucla.cs.scai.linkedspending.qald.JsonSubmission;
import edu.ucla.cs.scai.linkedspending.qald.JsonUtterance;
...
public class QA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String l;
        JsonSubmission submission=new JsonSubmission(new JsonDataset("qald-6-train-datacube"));
        int id=1;
        ...
        PrintWriter sout=new PrintWriter(new FileOutputStream("/home/massimo/Downloads/benchmarkdatasets/test.json", false), true);
